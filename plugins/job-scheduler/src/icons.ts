...
const pipelineSvg = `<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
  id="jupyter-ml-pipeline-icon" width="32px" height="32px" viewBox="0 0 32 32" title="Local Pipeline">
