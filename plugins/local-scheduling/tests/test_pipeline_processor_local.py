...
from tests.util import PythonNode
...
def test_pipeline_execution_order_in_complex_pipeline():
    ...
    pipeline_json = _read_pipeline_resource("pipeline_dependency_complex.json")
...
def test_pipeline_execution_order_in_simple_pipeline():
    ...
    pipeline_json = _read_pipeline_resource("pipeline_dependency_simple.json")
